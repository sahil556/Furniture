			...
			<div class="offcanvas__inner">
                ...
                <ul class="offcanvas__sub_menu">
                    ...
                    <li class="offcanvas__sub_menu_li"><a href="404.html" class="offcanvas__sub_menu_item">Error Page</a></li>
						...
						<li class="offcanvas__menu_li"><a
							class="offcanvas__menu_item" href="furea-contactp">Contact</a></li>
					</ul>
				...
				<div class="row row-cols-1">
					<div class="col">
						<div class="breadcrumb__content">
							<h1 class="breadcrumb__content--title text-white mb-10">Account
								Page</h1>
							...
							<form action="/signin" method="post">
								<div class="account__login">
									<div class="account__login--header mb-25">
										...
										<p class="account__login--header__desc">Login if you area
											a returning customer.</p>
									</div>
									<div class="account__login--inner">
										<label> <input class="account__login--input"
											placeholder="Email Addres" type="email" name="email">
										</label> <label> <input class="account__login--input"
										...
										<div
											...
											<button class="account__login--forgot" type="submit">Forgot
										...
										<p class="account__login--signup__text">
											...
											<button type="button" onclick="register();">Sign up
												now</button>
										</p>
									</div>
								</div>
						...
						<div class="col" id="register" style="display: none;">
							<form action="signup" method="post" enctype="multipart/form-data">
								<div class="account__login register">
									<div class="account__login--header mb-25">
										<h3 class="account__login--header__title mb-10">Create an
											Account</h3>
										<p class="account__login--header__desc">Register here if
											you are a new customer</p>
									</div>
									...
									<div class="account__login--inner">
										<label> <input class="account__login--input"
											...
											placeholder="Email Addres" name="email" type="email">
										</label> <label> <input class="account__login--input"
											placeholder="Password" name="password" type="password">
										</label> <label> <input class="account__login--input"
											placeholder="Your Address" name="address">
										</label> <label> <input class="account__login--input"
											placeholder="Pincode" type="number" name="pincode">
										</label> <label> <input class="account__login--btn"
											id="fileInput" value="${user.imageurl}" type="file"
											accept="image/jpeg, image/png, image/gif" name="imageUrl"
											required />
										</label><br>
										<div class="account__login--remember position__relative">
											<input class="checkout__checkbox--input" id="check2"
												...
												class="checkout__checkbox--checkmark"></span> <label
												class="checkout__checkbox--label login__remember--label"
												for="check2"> I have read and agree to the terms &
												conditions</label>
										</div>
										<br> <label>
							...
							<ul class="footer__widget--menu footer__widget--inner">
								<li class="footer__widget--menu__list"><a
									class="footer__widget--menu__text" href="furea-about">About
										Us</a></li>
								<li class="footer__widget--menu__list"><a
									class="footer__widget--menu__text" href="furea-wishlist">Wishlist</a></li>
								<li class="footer__widget--menu__list"><a
									class="footer__widget--menu__text" href="furea-contact">Contact
										Us</a></li>
								<li class="footer__widget--menu__list"><a
									class="footer__widget--menu__text" href="furea-privacy-policy">Privacy
										Policy</a></li>
								<li class="footer__widget--menu__list"><a
