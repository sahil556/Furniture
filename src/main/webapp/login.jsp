<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
        ...
        <header class="header__section header__transparent">
                ...
                <div class="container-fluid">
                    <div
                        ...
                        <div class="offcanvas__header--menu__open ">
                            <a class="offcanvas__header--menu__open--btn" href="javascript:void(0)"> <svg
                        ...
                        <div class="header__menu d-none d-lg-block">
                            <nav class="header__menu--navigation">
                                <ul class="d-flex">
                                    <li class="header__menu--items"><a class="header__menu--link" href="home.jsp">Home
                                        </a></li>
                                    <li class="header__menu--items"><a class="header__menu--link" href="about.jsp">About
                                            US </a></li>
                                    <li class="header__menu--items"><a class="header__menu--link"
            ...
            <div class="offcanvas-header" tabindex="-1">
                <div class="offcanvas__inner">
                    <div class="offcanvas__logo">
                        <a class="offcanvas__logo_link" href="index.html"> <img src="assets/img/logo/nav-log.webp"
                                alt="Furea Logo">
                        </a>
                    ...
                    <nav class="offcanvas__menu">
                        <ul class="offcanvas__menu_ul">
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="home.jsp">Home</a>
                            </li>
                ...
                <ul class="offcanvas__sub_menu">
                    ...
                    <li class="offcanvas__sub_menu_li"><a href="404.html" class="offcanvas__sub_menu_item">Error Page</a></li>
                            ...
                            <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="about.jsp">About</a>
                            </li>
                        ...
                        <div class="offcanvas__account--items">
                            <a class="offcanvas__account--items__btn d-flex align-items-center" href="login.html">
                                <span class="offcanvas__account--items__icon"> <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="offcanvas__stikcy--toolbar" tabindex="-1">
                <ul class="d-flex justify-content-between">
                    <li class="offcanvas__stikcy--toolbar__list"><a class="offcanvas__stikcy--toolbar__btn"
                            href="index.html"> <span class="offcanvas__stikcy--toolbar__icon"> <svg
                                    xmlns="http://www.w3.org/2000/svg" fill="none" width="21.51" height="21.443"
                                    viewBox="0 0 22 17">
                    ...
                    <li class="offcanvas__stikcy--toolbar__list"><a class="offcanvas__stikcy--toolbar__btn"
                            href="shop.html"> <span class="offcanvas__stikcy--toolbar__icon"> <svg fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" width="18.51" height="17.443"
                                    viewBox="0 0 448 512">
                                    <path
                    ...
                    <li class="offcanvas__stikcy--toolbar__list "><a
                            class="offcanvas__stikcy--toolbar__btn search__open--btn" href="javascript:void(0)">
                            <span class="offcanvas__stikcy--toolbar__icon"> <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="offCanvas__minicart" tabindex="-1">
                ...
                <div class="minicart__product">
                    <div class="minicart__product--items d-flex">
                        <div class="minicart__thumbnail">
                            <a href="product-details.html"><img src="assets/img/product/product1.webp"
                                    alt="prduct-img"></a>
                        </div>
                        <div class="minicart__text">
                            ...
                            <div class="minicart__price">
                                <span class="current__price">$125.00</span> <span class="old__price">$140.00</span>
                            </div>
                            <div class="minicart__text--footer d-flex align-items-center">
                                <div class="quantity__box minicart__quantity">
                                    ...
                                    <label> <input type="number" class="quantity__number" value="1" />
                                    </label>
                    ...
                    <div class="minicart__product--items d-flex">
                        <div class="minicart__thumbnail">
                            <a href="product-details.html"><img src="assets/img/product/product2.webp"
                                    alt="prduct-img"></a>
                        </div>
                        <div class="minicart__text">
                            <h4 class="minicart__subtitle">
                            ...
                            <div class="minicart__price">
                                <span class="current__price">$115.00</span> <span class="old__price">$130.00</span>
                            </div>
                            <div class="minicart__text--footer d-flex align-items-center">
                                <div class="quantity__box minicart__quantity">
                                    <button type="button" class="quantity__value decrease" aria-label="quantity value"
                ...
                <div class="minicart__conditions text-center">
                    <input class="minicart__conditions--input" id="accept" type="checkbox"> <label
                        class="minicart__conditions--label" for="accept">I agree with the <a
                ...
                <div class="minicart__button d-flex justify-content-center">
                    <a class="primary__btn minicart__button--link" href="cart.html">View
                        cart</a> <a class="primary__btn minicart__button--link" href="checkout.html">Checkout</a>
                </div>
            </div>
            ...
            <div class="predictive__search--box " tabindex="-1">
                <div class="predictive__search--box__inner">
                    ...
                    <form class="predictive__search--form" action="#">
                        <label> <input class="predictive__search--input" placeholder="Search Here" type="text">
                        </label>
                                    ...
                                    <div class="account__login">
                                        ...
                                        <div class="account__login--inner">
                                            ...
                                            <p class="account__login--signup__text">Don,t Have an Account? <button
                                                    type="button" onclick="register();">Sign up now</button></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="col" id="register" style="display: none;">
                                <form action="signup" method="post" enctype="multipart/form-data">
                                    <div class="account__login register">
                                        ...
                                        <div class="account__login--inner">
                                            <label>
                                                <input class="account__login--input" placeholder="Firstname"
                                                    name="firstname" type="text">
                                            </label>
                                            <label>
                                                <input class="account__login--input" placeholder="Lastname"
                                            ...
                                            <label>
                                                <input class="account__login--input" placeholder="Pincode" type="number"
                                                    name="pincode">
                                            </label>
                                            <label>
                                                

                                                <input class="account__login--btn" id="fileInput"
                                                    value="${user.imageurl}" type="file" accept="image/jpeg, image/png, image/gif" name="imageUrl"
                                                    required />
                                            </label><br>
                                            <div class="account__login--remember position__relative">
                                            ...
                                            <label>
                                                ...
                                                <button class="account__login--btn primary__btn mb-10" type="button"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget--inner">
                                    <a class="footer__logo" href="index.html"><img src="assets/img/logo/nav-log.webp"
                                            alt="footer-logo"></a>
    ...
    <script>
        ...
        if(input !== undefined && decrese !== undefined && increase !== undefined && input !== null && increase !== null && decrese !== null)
        {
